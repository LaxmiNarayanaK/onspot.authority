        ...
        axios
          ...
          .then((response) => {
            ...
            let statusMessage =
              ...
              caseId +
              "). Please login to check the details. \n\nIf you have additional questions, feel free to send an email to contact.onspot@gmail.com or comment on the report. Thank you for being a part of the Onspot community.";
            axios
              .post(SEND_EMAIL, {
                data: {
                  ...
                  subject:
                    "Case Id #" +
                    caseId +
                    ": New Notification from Onspot (Your Report Status)",
