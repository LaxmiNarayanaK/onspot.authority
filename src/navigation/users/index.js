    ...
    axios
      ...
      .then((response) => {
        let allowedMessage =
          ...
          ",\n\nWe have decided to turn your status back to allowed. You can now try signing into your account now. \n\nIf you have additional questions, feel free to send an email to contact.onspot@gmail.com. Thank you for being a part of the Onspot community.";
        let blockedMessage =
          "Hi " +
          this.state.clickedRow[1] +
          ",\n\nThere seems to be some unusual activity from your account. Your status has to be turned to blocked. \n\nIf you have additional questions, feel free to send an email to contact.onspot@gmail.com. Thank you for joining the Onspot community.";
        axios
          .post(SEND_EMAIL, {
            data: {
              emailId: this.state.clickedRow[2],
              subject: "New Notification from Onspot (Your Account Status)",
              message:
